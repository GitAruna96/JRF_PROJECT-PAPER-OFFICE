...
def save_history_to_csv(history, model_name, output_dir):
    ...
    csv_path = os.path.join(output_dir, f'{model_name}_office_ssc_pseudo__aw_d_results.csv')
...
def main():
    ...
    trg_evaluate_loader = get_loader(name_dataset='dslr', batch_size=batch_size, train=False,is_target=False)
    ...
    for epoch in range(no_epochs):
        ...
        if test_acc > best_acc:
            ...
            torch.save(model.state_dict(), os.path.join(output_dir, 'best_office_swin_ssc_aw_d_pseudo_model.pth'))
