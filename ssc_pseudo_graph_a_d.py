...
# Load your results
df = pd.read_csv('C:\\Users\\Admin\\Aruna_jrf_projects\\Datasets\\Office-31\\paper_experiments\\results\\swin_t_office_ssc_pseudo_a_d_res.csv')
...
plt.tight_layout()
save_figure(fig1, '1.ssc_pseudo_collapse A to D')
...
plt.tight_layout()
save_figure(fig2, '2.A to D loss_components')
...
plt.tight_layout()
save_figure(fig3, '3.A to D timing_overhead')
...
ax4a.set_title('SSC + Pseudo-Labeling: Performance Collapse on A to D Task')
ax4a.legend()
...
plt.tight_layout()
save_figure(fig4, '4.A to D combined_analysis')
...
summary_path = f'{plot_dir}/ssc_pseudo_performance_A to D_summary.csv'
