...
# Setup
# =========================
csv_path = r'./improved_a_d_results_amazon_to_dslr\\amazon_to_dslr_swin_small_patch4_window7_224_improved_a_d_results_20250924_161438.csv'
plot_dir = r'C:\\Users\\Admin\\Aruna_jrf_projects\\Datasets\\Office-31\\paper_experiments\\sac_DA_plots\\a_d_bigsize'
...
plt.title("Accuracy vs Training Time (A→D)", fontweight="bold", fontsize=13, pad=15)
plt.tight_layout()
plt.savefig(f"{plot_dir}/A_D_accuracy_time_fixed.png", dpi=600, bbox_inches="tight")
plt.savefig(f"{plot_dir}/A_D_accuracy_time_fixed.pdf", dpi=600, bbox_inches="tight")
plt.close()
...
plt.suptitle("SAC Domain Adaptation Analysis: Amazon to dslr (Office-31)", 
             fontsize=15, fontweight="bold", y=0.98)
plt.tight_layout()
plt.subplots_adjust(top=0.93, wspace=0.3, hspace=0.4)

plt.savefig(f"{plot_dir}/A_D_training_analysis_fixed.png", dpi=600, bbox_inches="tight")
plt.savefig(f"{plot_dir}/A_D_training_analysis_fixed.pdf", dpi=600, bbox_inches="tight")
plt.close()
...
ax1.set_title("Test Accuracy (D→A)", fontweight="bold", fontsize=13)
...
plt.tight_layout()
plt.savefig(f"{plot_dir}/D_W_separate_plots.png", dpi=600, bbox_inches="tight")
plt.savefig(f"{plot_dir}/D_W_separate_plots.pdf", dpi=600, bbox_inches="tight")
plt.close()
...
print("\n" + "="*60)
print("SAC DOMAIN ADAPTATION SUMMARY - Amazon to DSLR ")
print("="*60)
