...
# Setup
# =========================
csv_path = r'./improved1_results_dslr_to_webcam\dslr_to_webcam_swin_small_patch4_window7_224_impr1_results_d_w_20250924_185809.csv'
plot_dir = r'C:\\Users\\Admin\\Aruna_jrf_projects\\Datasets\\Office-31\\paper_experiments\\sac_DA_plots\\d_w_bigsize'
...
plt.title("Accuracy vs Training Time (D→W)", fontweight="bold", fontsize=12, pad=12)
plt.tight_layout()
plt.savefig(f"{plot_dir}/D_W_accuracy_time_enhanced.png", dpi=600, bbox_inches="tight")
plt.savefig(f"{plot_dir}/D_W_accuracy_time_enhanced.pdf", dpi=600, bbox_inches="tight")
plt.close()
...
plt.suptitle("SAC Domain Adaptation Analysis: DSLR to Webcam (Office-31)", 
             fontsize=14, fontweight="bold", y=0.98)
plt.tight_layout()
plt.subplots_adjust(top=0.93, wspace=0.35, hspace=0.45)  # More spacing

plt.savefig(f"{plot_dir}/D_w_training_analysis_enhanced.png", dpi=600, bbox_inches="tight")
plt.savefig(f"{plot_dir}/D_w_training_analysis_enhanced.pdf", dpi=600, bbox_inches="tight")
plt.close()
...
plt.title("Accuracy and Confidence Evolution (D→w)", fontweight="bold", fontsize=13, pad=15)
plt.tight_layout()
plt.savefig(f"{plot_dir}/D_w_accuracy_enhanced_confidence_combined.png", dpi=600, bbox_inches="tight")
plt.savefig(f"{plot_dir}/D_w_accuracy_enhanced_confidence_combined.pdf", dpi=600, bbox_inches="tight")
plt.close()
...
print("\n" + "="*60)
print("SAC DOMAIN ADAPTATION SUMMARY - DSLR to Webcam")
print("="*60)
