...
def save_history_to_csv(history, model_name, output_dir):
    ...
    csv_path = os.path.join(output_dir, f'{model_name}_ad_w_sac_predrev_results_{timestamp}.csv')
...
def main():
    ...
    source_domains = ['amazon', 'dslr']  # Your multi-source domains
    ...
    for epoch in range(num_epochs):
        ...
        if test_acc > best_acc:
            ...
            # Save regular model
            torch.save(model.state_dict(), os.path.join(output_dir, f'multi_source_sac_rev_pred_ad_w_{model_name}.pth'))
    ...
    # Save results
    save_history_to_csv(history, f'multi_source_{model_name}_AD_W_sac_rev_pred', output_dir)
