...
# Load your results
df = pd.read_csv('C:\\Users\\Admin\\Aruna_jrf_projects\\Datasets\\Office-31\\paper_experiments\\results\\swin_t_office_ssc_pseudo_results.csv')
...
plt.tight_layout()
save_figure(fig1, '1.ssc_pseudo_collapse AD to W')
...
plt.tight_layout()
save_figure(fig2, '2.AD to W loss_components')
...
plt.tight_layout()
save_figure(fig3, '3.AD to W timing_overhead')
...
ax4a.set_title('SSC + Pseudo-Labeling: Performance Collapse on FO→FP Task')
ax4a.legend()
...
plt.tight_layout()
save_figure(fig4, '4.AD to W combined_analysis')
...
summary_path = f'{plot_dir}/ssc_pseudo_performance_AD to W_summary.csv'
