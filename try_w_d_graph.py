...
# Setup
# =========================
csv_path = r'C:\\Users\\Admin\\Aruna_jrf_projects\\Datasets\\Office-31\\paper_experiments\\improved_results_webcam_to_dslr\\webcam_to_dslr_swin_small_patch4_window7_224_improved_results_1__w_d_20250925_145019.csv'
plot_dir = r'C:\\Users\\Admin\\Aruna_jrf_projects\\Datasets\\Office-31\\paper_experiments\\sac_DA_plots\\w_d_bigsize'
os.makedirs(plot_dir, exist_ok=True)

df = pd.read_csv(csv_path)
baseline_acc = 100  # Baseline accuracy
...
plt.title("Accuracy vs Training Time (W→D)", fontweight="bold", fontsize=12, pad=12)
plt.tight_layout()
plt.savefig(f"{plot_dir}/W_D_accuracy_time_enhanced.png", dpi=600, bbox_inches="tight")
plt.savefig(f"{plot_dir}/W_D_accuracy_time_enhanced.pdf", dpi=600, bbox_inches="tight")
plt.close()
...
plt.suptitle("SAC Domain Adaptation Analysis: Webcam to DSLR (Office-31)", 
             fontsize=14, fontweight="bold", y=0.98)
plt.tight_layout()
plt.subplots_adjust(top=0.93, wspace=0.35, hspace=0.45)  # More spacing

plt.savefig(f"{plot_dir}/W_D_training_analysis_enhanced.png", dpi=600, bbox_inches="tight")
plt.savefig(f"{plot_dir}/W_D_training_analysis_enhanced.pdf", dpi=600, bbox_inches="tight")
plt.close()
...
plt.title("Accuracy and Confidence Evolution (W→D)", fontweight="bold", fontsize=13, pad=15)
plt.tight_layout()
plt.savefig(f"{plot_dir}/W_D_accuracy_enhanced_confidence_combined.png", dpi=600, bbox_inches="tight")
plt.savefig(f"{plot_dir}/W_D_accuracy_enhanced_confidence_combined.pdf", dpi=600, bbox_inches="tight")
plt.close()
...
print("\n" + "="*60)
print("SAC DOMAIN ADAPTATION SUMMARY - Webcam to DSLR")
print("="*60)
