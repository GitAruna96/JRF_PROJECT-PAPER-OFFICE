...
# Load your results
df = pd.read_csv('C:\\Users\\Admin\\Aruna_jrf_projects\\Datasets\\Office-31\\paper_experiments\\results\\swin_t_office_ssc_pseudo__aw_d_results.csv')
...
plt.tight_layout()
save_figure(fig1, '1.ssc_pseudo_collapse AW to D')
...
plt.tight_layout()
save_figure(fig2, '2.AW to D loss_components')
...
plt.tight_layout()
save_figure(fig3, '3.AW to D timing_overhead')
...
ax4a.set_title('SSC + Pseudo-Labeling: Performance Collapse on AW to D Task')
ax4a.legend()
...
plt.tight_layout()
save_figure(fig4, '4.AW to D combined_analysis')
...
summary_path = f'{plot_dir}/ssc_pseudo_performance_AW to D_summary.csv'
