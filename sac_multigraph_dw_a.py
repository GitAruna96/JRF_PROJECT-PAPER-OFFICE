...
csv_path = r'C:\\Users\\Admin\Aruna_jrf_projects\\Datasets\\Office-31\\paper_experiments\\results_multi_source\\multi_source_swin_tiny_patch4_window7_224_dw_a_sac_rev_pred_dw_a_sac_predrev_results_20250916_185123.csv'
...
plt.tight_layout()
plt.savefig(f'{plot_dir}/1. sac_dw_a_accuracy_curve.png', dpi=300, bbox_inches='tight')
plt.savefig(f'{plot_dir}/1. sac_dw_a_accuracy_curve.pdf', bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig(f'{plot_dir}/2. sac_dw_a_loss_components.png', dpi=300, bbox_inches='tight')
plt.savefig(f'{plot_dir}/2. sac_dw_a_loss_components.pdf', bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig(f'{plot_dir}/3. sac_dw_a_confidence_schedule.png', dpi=300, bbox_inches='tight')
plt.savefig(f'{plot_dir}/3. sac_dw_a_confidence_schedule.pdf', bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig(f'{plot_dir}/4. sac_dw_a_timing_analysis.png', dpi=300, bbox_inches='tight')
plt.savefig(f'{plot_dir}/4. sac_dw_a_timing_analysis.pdf', bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig(f'{plot_dir}/5. sac_dw_a_combined_analysis.png', dpi=300, bbox_inches='tight')
plt.savefig(f'{plot_dir}/5. sac_dw_a_combined_analysis.pdf', bbox_inches='tight')
plt.show()
...
summary_df.to_csv(f'{plot_dir}/sac_dw_a_performance_summary.csv', index=False)
print(f"\nAnalysis summary saved to: {plot_dir}/sac_dw_a_performance_summary.csv")

print(f"\n🎉 All plots saved to: {plot_dir}/")
print("✓ 1. sac_dw_a_accuracy_curve.png")
print("✓ 2. sac_dw_a_loss_components.png") 
print("✓ 3. sac_dw_a_confidence_schedule.png")
print("✓ 4. sac_dw_a_timing_analysis.png")
print("✓ 5. sac_dw_a_combined_analysis.png")
print("✓ 6. sac_dw_a_vs_baseline.png")
print("✓ sac_dw_a_performance_summary.csv")