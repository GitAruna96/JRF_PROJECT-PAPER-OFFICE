...
def save_history_to_csv(history, model_name, output_dir):
    ...
    csv_path = os.path.join(output_dir, f'{model_name}_office_ssc_pseudo_a_d_res.csv')
...
def main():
    ...
    for epoch in range(no_epochs):
        ...
        if test_acc > best_acc:
            ...
            torch.save(model.state_dict(), os.path.join(output_dir, '_office_ssc_pseudo_a_d_model.pth'))
