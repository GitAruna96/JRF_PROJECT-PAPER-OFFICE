...
def save_history_to_csv(history, model_name, output_dir):
    ...
    csv_path = os.path.join(output_dir, f'{model_name}_sac_single_d_w_results_{timestamp}.csv')
...
def main():
    ...
    for epoch in range(num_epochs):
        ...
        if test_acc > best_acc:
            ...
            # Save best model
            model_path = os.path.join(output_dir, f'best_modelsac_d_w__{model_name}.pth')
