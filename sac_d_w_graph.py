...
csv_path = r'C:\\Users\\Admin\\Aruna_jrf_projects\\Datasets\\Office-31\\paper_experiments\\results_dslr_to_webcam\\dslr_to_webcam_swin_tiny_patch4_window7_224_sac_single_d_w_results_20250916_163055.csv'
...
plt.axhline(y=98.88, color='red', linestyle='--', linewidth=2, label='Baseline (98.88)')
...
plt.tight_layout()
plt.savefig(f'{plot_dir}/1. sac_d_w_accuracy_curve.png', dpi=300, bbox_inches='tight')
plt.savefig(f'{plot_dir}/1. sac_d_w_accuracy_curve.pdf', bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig(f'{plot_dir}/2. sac_d_w_loss_components.png', dpi=300, bbox_inches='tight')
plt.savefig(f'{plot_dir}/2. sac_d_w_loss_components.pdf', bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig(f'{plot_dir}/3. sac_d_w_confidence_schedule.png', dpi=300, bbox_inches='tight')
plt.savefig(f'{plot_dir}/3. sac_d_w_confidence_schedule.pdf', bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig(f'{plot_dir}/4. sac_d_W_timing_analysis.png', dpi=300, bbox_inches='tight')
plt.savefig(f'{plot_dir}/4. sac_d_w_timing_analysis.pdf', bbox_inches='tight')
plt.show()
...
ax1.axhline(y=98.88, color='red', linestyle='--', linewidth=2, label='Baseline (98.88%)')
...
plt.tight_layout()
plt.savefig(f'{plot_dir}/5. sac_d_w_combined_analysis.png', dpi=300, bbox_inches='tight')
plt.savefig(f'{plot_dir}/5. sac_d_w_combined_analysis.pdf', bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig(f'{plot_dir}/6. sac_d_w_vs_baseline.png', dpi=300, bbox_inches='tight')
plt.savefig(f'{plot_dir}/6. sac_d_w_vs_baseline.pdf', bbox_inches='tight')
plt.show()
...
print(f"Baseline Accuracy: 98.88%")
print(f"Improvement: {best_acc-98.88:+.2f}%")
...
summary_df.to_csv(f'{plot_dir}/sac_d_w_performance_summary.csv', index=False)
print(f"\nAnalysis summary saved to: {plot_dir}/sac__d_w_performance_summary.csv")

print(f"\n🎉 All plots saved to: {plot_dir}/")
print("✓ 1. sac__d_w_accuracy_curve.png")
print("✓ 2. sac__d_w_loss_components.png") 
print("✓ 3. sac__d_w_confidence_schedule.png")
print("✓ 4. sac__d_w_timing_analysis.png")
print("✓ 5. sac__d_w_combined_analysis.png")
print("✓ 6. sac__d_w_vs_baseline.png")
print("✓ sac__d_w_performance_summary.csv")