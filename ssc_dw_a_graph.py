...
# Load your results
df = pd.read_csv('./results/swin_t office_11_dw_a_ssc_results.csv')
...
plt.plot(df['Epoch'], df['Test_Accuracy'], 'ro-', linewidth=2.5, markersize=8, label='Test Accuracy (Target - A)')
plt.plot(df['Epoch'], df['Train_Accuracy'], 'bo-', linewidth=2.5, markersize=8, label='Train Accuracy (Source - DW)', alpha=0.7)

plt.xlabel('Epoch', fontsize=14, fontweight='bold')
plt.ylabel('Accuracy (%)', fontsize=14, fontweight='bold')
plt.title('SSC Performance: DW → A Domain Adaptation\n(Swin-T Backbone, 50 Epochs)', fontsize=16, fontweight='bold')
...
plt.tight_layout()
plt.savefig(f'{plot_dir}/1. ssc_dw_a_accuracy_curve.png', dpi=300, bbox_inches='tight')
plt.savefig(f'{plot_dir}/1. ssc_dw_a_accuracy_curve.pdf', bbox_inches='tight')
plt.show()

# 2. Loss Components Analysis
plt.figure(figsize=(14, 8))
plt.plot(df['Epoch'], df['Train_Loss'], 'g-', linewidth=2.5, label='Classification Loss (Source)')
plt.plot(df['Epoch'], df['SSC_Loss'], 'b-', linewidth=2.5, label='SSC DW_A Loss (Target)')
...
plt.title('Loss Components: SSC Training Dynamics\n(DW → A Domain Adaptation)', fontsize=16, fontweight='bold')
plt.legend(fontsize=12)
plt.grid(True, alpha=0.3)
...
plt.tight_layout()
plt.savefig(f'{plot_dir}/2. ssc_dw_a_loss_components.png', dpi=300, bbox_inches='tight')
plt.savefig(f'{plot_dir}/2. ssc_dw_a_loss_components.pdf', bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig(f'{plot_dir}/3. ssc_dw_a_timing_analysis.png', dpi=300, bbox_inches='tight')
plt.savefig(f'{plot_dir}/3. ssc_dw_a_timing_analysis.pdf', bbox_inches='tight')
plt.show()
...
plt.title('Time-Accuracy Tradeoff: SSC Domain Adaptation\n(Dw to A, Swin-T Backbone)', fontsize=16, fontweight='bold')
fig.tight_layout()
plt.savefig(f'{plot_dir}/4.ssc_dw_a_time_accuracy_tradeoff.png', dpi=300, bbox_inches='tight')
plt.savefig(f'{plot_dir}/4. ssc_dw_a_time_accuracy_tradeoff.pdf', bbox_inches='tight')
plt.show()
...
ax1.set_title('A) SSC Performance: DW to A Domain Adaptation', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig(f'{plot_dir}/5.ssc_dw_a_combined_analysis.png', dpi=300, bbox_inches='tight')
plt.savefig(f'{plot_dir}/5. ssc_dw_a_combined_analysis.pdf', bbox_inches='tight')
plt.show()
...
summary_df.to_csv(f'{plot_dir}/ssc_DW_to_A_performance_summary.csv', index=False)
print(f"\nAnalysis summary saved to: {plot_dir}/ssc_DW_to_A_performance_summary.csv")