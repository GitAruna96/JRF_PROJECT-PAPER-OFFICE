...
def save_history_to_csv(history, model_name, output_dir):
    ...
    csv_path = os.path.join(output_dir, f'{model_name} office_11_ad_w_ssc_results.csv')
...
def main():
    ...
    trg_train_loader = get_loader(name_dataset='dslr', batch_size=batch_size, train=True)
    ...
    for epoch in range(no_epochs):
        ...
        if test_acc > best_acc:
            best_acc = test_acc
            torch.save(model.state_dict(), 'best_modeloffice_11_ad_w_ssc.pth')
