...
def analyze_experiment(csv_path):
    ...
    plt.tight_layout()
    plot_path = os.path.join(plot_dir, f'{model_name}_d_w_training_curves.png')
    ...
    timing_path = os.path.join(plot_dir, f'{model_name}_d_w_timing_analysis.png')
...
if __name__ == '__main__':
    ...
    specific_csv_path = r"C:\\Users\\Admin\\Aruna_jrf_projects\\Datasets\\Office-31\\paper_experiments\\results\\swin_t_office_cls_d_w_results_20250913_181033.csv"
